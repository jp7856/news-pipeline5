...
The lowest is called Top News Kinder and it is for kindergarteners and early elementary school \
students, and the language level is at CEFR level of A1 or lower. \
The next newspaper is called Top News Kids and it is for elementary school students studying \
...
# 레벨별 신문 설정
# ------------------------------------------------------------------
# 수치 기준: 2026-06 실제 발행 5개 매체 전수 분석 (basic.xlsx, 산문 기사 248건).
