...
- FK 상한을 실제 발행 기사 실측에 맞게 조정 (표의 일반 영어 기준값은 너무 낮았음)
...
#   TIMES_L3    20    14.0    19.0     48       6      14.0   ← articles.xlsx 보정 (2026-06, 현행 2024~ p10 기준)
# --------------------------------------------------------------------------
@dataclass
class LevelSpec:
    name: str
...
LEVELS: dict[str, LevelSpec] = {
    ...
    "TIMES_L3":  LevelSpec("TIMES L3",  14.0, 19.0, 48, 6, 14.0),
}
