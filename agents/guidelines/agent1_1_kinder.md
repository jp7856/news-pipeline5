<!--
에이전트 1-1 (KINDER) — Top News Kinder 기사 작성 지침
...
Top News Kinder — the word count, average sentence length, paragraph count, and CEFR for the assigned sub-level are provided in the main prompt (single source of truth: config). Write exactly within them. The rules below define this newspaper's writing style.
...
- L1: plan roughly 5–6 tiny paragraphs of ~8–9 words each.
- L2: plan roughly 8 tiny paragraphs of ~9 words each (subheading lines count as their own line).
